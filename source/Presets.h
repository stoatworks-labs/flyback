...
// 0 None / 1 Floor / 2 Point; Gas 0 Air / 1 Neon / 2 Argon; Origin 0 Point /
...
// sphere, 0.7686 a 10 cm gap, 0.7500 a 0.20 m globe, 0.1875 14 degrees,
...
inline constexpr Preset kPresets[] = {
	...
	{ "Tesla Coil",
	  { /*Machine*/ 1, /*Supply*/ 1, /*Voltage*/ 0.5f, /*Imp*/ 0.5f, /*Branch*/ 0.5f, /*Memory*/ 0.5f, /*Reach*/ 0.5f,
	    /*Spread*/ 0.1875f, /*RodLen*/ 0.4286f, /*Rise*/ 0.5943f, /*Wind*/ 0.5f, /*BPS*/ 0.6078f, /*Top*/ 0.3103f,
	...
	{ "Jacob's Ladder",
	  { /*Machine*/ 0, /*Supply*/ 1, /*Voltage*/ 0.5f, /*Imp*/ 0.5f, /*Branch*/ 0.5f, /*Memory*/ 0.5f, /*Reach*/ 0.5f,
	    /*Spread*/ 0.1875f, /*RodLen*/ 0.4286f, /*Rise*/ 0.5943f, /*Wind*/ 0.5f, /*BPS*/ 0.6078f, /*Top*/ 0.3103f,
	    /*Target*/ 1, /*Belt*/ 0.5886f, /*Sphere*/ 0.4000f, /*Gap*/ 0.7686f, /*Globe*/ 0.7500f, /*Finger*/ 0,
	    /*Origin*/ 0, /*Eff*/ 0.5f, /*Glow*/ 0.50f, /*Gas*/ 0, /*Shutter*/ 1.0f, /*Persist*/ 0.35f } },
	...
	// A 40 cm argon globe on a small flyback driver.
	{ "Plasma Globe",
	  { /*Machine*/ 3, /*Supply*/ 2, /*Voltage*/ 0.5f, /*Imp*/ 0.5f, /*Branch*/ 0.5f, /*Memory*/ 0.5f, /*Reach*/ 0.5f,
	    /*Spread*/ 0.1875f, /*RodLen*/ 0.4286f, /*Rise*/ 0.5943f, /*Wind*/ 0.5f, /*BPS*/ 0.6078f, /*Top*/ 0.3103f,
	    /*Target*/ 1, /*Belt*/ 0.5886f, /*Sphere*/ 0.4000f, /*Gap*/ 0.7686f, /*Globe*/ 0.7500f, /*Finger*/ 0,
	    /*Origin*/ 0, /*Eff*/ 0.5f, /*Glow*/ 0.55f, /*Gas*/ 2, /*Shutter*/ 1.0f, /*Persist*/ 0.30f } },
